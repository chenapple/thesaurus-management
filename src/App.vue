        ...
        <div class="help-content-area">
          ...
          <div class="help-content">
            ...
            <ul>
              ...
              <li><strong>汇率显示：</strong>实时轮播显示主要货币对人民币汇率，支持多种货币，点击齿轮图标可自定义选择显示哪些（最多5个），显示涨跌箭头指示</li>
              <li><strong>市场时钟：</strong>显示目标市场当地时间，滚轮切换不同市场（美国、英国、德国、法国、日本、中国）</li>
              <li><strong>电商日历：</strong>点击日历按钮查看全年电商节日和促销活动，包含大促、西方节日、中国节日、日本节日等</li>
              <li><strong>节日提醒：</strong>距离节日 14 天内时自动弹出提醒，AI 智能生成准备建议，支持多节日切换浏览</li>
            </ul>
              ...
              <el-collapse-item name="rankingDisplay">
                ...
                <div class="prompt-section">
                  ...
                  <ul>
                    ...
                    <li><strong>注意：</strong>趋势图需要至少 2 天的排名数据才会显示（同一天多次检测会聚合为当天最佳排名）</li>
                  </ul>
                </div>
              </el-collapse-item>
